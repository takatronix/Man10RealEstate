...
import red.man10.realestate.util.MySQLManager.Companion.escapeStringForMySQL
...
//            User.ownerList[p] = list
    ...
    fun showTaxAndRent(p:Player){
        ...
        while (rs1.next()){
            ...
            totalTax += CityOld.getTax(CityOld.whereRegion(id),id)
            total++
